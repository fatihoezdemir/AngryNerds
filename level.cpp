...
void Level::initPlayField() {
    ...
    staticObjects.append(new StaticObject(QPixmap(":/imgs/png/Person_2.png").scaled(200,600), QPoint(2500.0,900.0), world));
    //staticObjects.append(new StaticObject(QPixmap(":/imgs/png/Person_5.png").scaled(150,450), QPoint(1400.0,200.0), world));
...
void Level::timerEvent ( QTimerEvent* event )
{
    ...
    // forcefieldfunction
    //forcefield(m_projectile->shoot(b2Vec2(-10.9,20.0));
...
void Level::mousePressEvent(QMouseEvent* event){
    //m_projectile->shoot(b2Vec2(-50,30.0));
}
